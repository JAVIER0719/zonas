...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 22-08-2023 a las 15:09:46
...
CREATE TABLE `recursos` (
  ...
  `img_link` text COLLATE utf8mb4_spanish2_ci NOT NULL,
  `fk_docus` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
INSERT INTO `recursos` (`id_recurso`, `tipo_recurso`, `fecha_de_creacion`, `img_link`, `fk_docus`) VALUES
(10, 'img', '2023-08-02', 'https://i.stack.imgur.com/alqSq.png', 123456744);
...
CREATE TABLE `resultado` (
  ...
  `pregunta_incorrecta` varchar(20) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `pregunta_incorrecta2` varchar(20) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `pregunta_incorrecta3` varchar(20) COLLATE utf8mb4_spanish2_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
INSERT INTO `resultado` (`id_ejercicio`, `materia`, `punto_correcto`, `pregunta_incorrecta`, `pregunta_incorrecta2`, `pregunta_incorrecta3`) VALUES
(1, 'español', 'd', '', '', ''),
(2, 'español', 'c', '', '', ''),
(3, 'español', 'b', '', '', ''),
(4, 'español', 'd', '', '', ''),
...
CREATE TABLE `resultado_usuario` (
  `id_resulatado` int(11) NOT NULL,
  `respuestas_correctas` varchar(45) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `respuestaincorrecta` varchar(45) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `tiempo_prueba` time NOT NULL,
  `fk_usodoc` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
...
CREATE TABLE `rol` (
  ...
  `estudiante` varchar(20) COLLATE utf8mb4_spanish2_ci NOT NULL,
...
INSERT INTO `rol` (`id_rol`, `estudiante`, `admin`, `descripcion_rol`) VALUES
('10', 'estudiante', 'admin', 'estudiante con problemas de conocimiento '),
('12', 'estudiante', 'admin', 'administrador el cual manda y arregla todo');
...
CREATE TABLE `usuario` (
  ...
  `clave` varchar(101) COLLATE utf8mb4_spanish2_ci NOT NULL,
  `cel` int(11) NOT NULL,
...
(123456744, 'tilin@gmail.com', 'tilin', 'david', 'patiño', 'cano', '1', 12345678, 'tl', '11', '12');
...
ALTER TABLE `notificacion`
  ...
  ADD KEY `fk_id_doc_usu` (`fk_id_doc_usu`);
...
ALTER TABLE `pruebas`
  ...
  ADD KEY `fk_resultado` (`fk_resultado`);

--
-- Indices de la tabla `ranking`
--
ALTER TABLE `ranking`
  ADD PRIMARY KEY (`id_raking`),
...
--
-- Indices de la tabla `resultado_usuario`
--
ALTER TABLE `resultado_usuario`
  ADD PRIMARY KEY (`id_resulatado`),
  ADD KEY `fk_usodoc` (`fk_usodoc`);
