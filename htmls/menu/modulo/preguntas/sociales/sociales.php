...
<body style="background: linear-gradient(white, skyblue);">
    ...
    <main>
        ...
        if ($fkRol == 12) {
            ?>
            <a href="dashboard.php?mod=crud-soc">scrud_sociales</a>
            <?php
        }
        ;
        ?>
        <form action="http://localhost/zonas/htmls/menu/dashboard.php?mod=Sociales" method="post">
