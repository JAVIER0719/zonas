...
if (!empty($_GET['id'])) {
    $id = $_GET['id'];
    $stmt = $conn->prepare("DELETE FROM matematicas WHERE id1 = ?");
        ...
        <div class="table-responsive">
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        <div class="col-sm-8">
                            <h2>CRUD <b>Materia de Matematicas</b></h2>
                        </div>
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_object()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="modulo/preguntas/matematica/preicfes/modificar.php?id=<?= $fila->id1 ?>"
                                        class="view" title="View" data-toggle="tooltip"><i
                                            class="material-icons">&#xE417;</i></a>
                                    <a href="modulo/preguntas/matematica/preicfes/agg/agregar.php" class="edit" title="Edit"
                                        data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <a href="modulo/preguntas/matematica/preicfes/crud-mat.php?id=<?= $fila->id1 ?>"
