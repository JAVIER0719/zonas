...
$query = $conn->query("SELECT * FROM ingles WHERE numero_pregunta=$id");
                        ...
                        while ($dato = $query->fetch_object()) { ?>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="a" class="form-control" value="<?= $dato->punto_correcto ?>">
                                </div>
                                <div class="form-group">
                                    <label>Opcion B</label>
                                    <input type="text" name="b" class="form-control" value="<?= $dato->punto ?>">
                                </div>
                                <div class="form-group">
                                    <label>Opcion C</label>
                                    <input type="text" name="c" class="form-control" value="<?= $dato->punto2 ?>">
                                </div>

                                <div class="form-group">
                                    <label>¿De que materia pertenece?</label>
                                    <input type="number" name="mat" class="form-control" value="<?= $dato->fk_materia ?>">
                                </div>
                                <div class="form-group">
                                    <label>¿Quien lo monta?</label>
                                    <input type="number" name="doc" class="form-control" value="<?= $dato->fk_usu1 ?>">
                                </div>
