...
if (!empty($_GET['id'])) {
    $id = $_GET['id'];
    $stmt = $conn->prepare("DELETE FROM ingles WHERE numero_pregunta = ?");
                    ...
                    <tbody>
                        ...
                        while ($fila = $resultado->fetch_object()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="modulo/preguntas/ingles/preicfes/modificar.php?id=<?= $fila->numero_pregunta ?>"
                                        class="view" title="View" data-toggle="tooltip"><i
                                            class="material-icons">&#xE417;</i></a>
                                    <a href="modulo/preguntas/ingles/preicfes/agg/agregar.php" class="edit" title="Edit"
                                        data-toggle="tooltip"><i class="material-icons">&#xE254;</i></a>
                                    <a href="modulo/preguntas/ingles/preicfes/crud-ing.php?id=<?= $fila->numero_pregunta ?>"
