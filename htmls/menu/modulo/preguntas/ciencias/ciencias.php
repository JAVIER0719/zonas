<?php
include("db.php");
$query = "SELECT * FROM `ciencias_naturalez`;";
...
<body style="background: linear-gradient(white, skyblue);">
    ...
    <main>
        ...
        if ($fkRol == 12) {
            ?>
            <a href="dashboard.php?mod=crud-cie">scrud_ciencias</a>
            <?php
        }
        ;
        ?>
        <form action="http://localhost/zonas/htmls/menu/dashboard.php?mod=Ciencias" method="post">
